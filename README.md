...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/rapid-bar-0d79)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/rapid-bar-0d79
```

A live public deployment of this template is available at [https://rapid-bar-0d79.templates.workers.dev](https://rapid-bar-0d79.templates.workers.dev)
